...
var Validation = (function () {
   ...
   * Status reversals, reassignment, exceptions and reopen carry their own checks
   * in StatusEngine and CaseService, because "reason" there depends on direction.
   */
  var REASON_REQUIRED_FIELDS = {
    Quote_Lines: ['Vendor_Unit_Price', 'Final_Unit_Price'],
    Case_Vendors: ['Response_Status'],
    Cases: ['Buyer_Owner']
  };
